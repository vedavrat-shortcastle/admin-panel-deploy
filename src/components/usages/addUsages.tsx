...
//                   {/* <Textarea
//                     disabled
//                     value={"Usage metrics color code\n0% Black\n< 20% Red\n20%-40% Orange\n40%-60% Blue\n60%-80% Light green\n80%-100% Dark green"}
//                     className="block w-full p-2 border rounded bg-gray-100"
//                   /> */}

//               <div className="flex justify-end space-x-2">
//                 <Button type="button" variant="outline">Back</Button>
//                 <Button type="submit" style={ { backgroundColor: "rgb(116, 112, 219)" }}   >Save</Button>
//               </div>
//               <FormItem>
//                 <FormLabel>Note</FormLabel>
//                 <FormControl>
//                     <Card className="w-full  " >
//                         <CardContent className="rounded-sm" style={ { backgroundColor: "rgb(245, 244, 255)" }} >
//                             <h2 className="text-sm font-semibold mb-2" >Usage metrics color code</h2>
//                             <ul className="text-sm">
//                             <li><span >0%</span> - Black</li>
//                             <li><span >&lt; 20%</span> - Red</li>
//                             <li><span >20% - 40%</span> - Orange</li>
//                             <li><span >40% - 60%</span> - Blue</li>
//                             <li><span >60% - 80%</span> - Light green</li>
//                             <li><span >80% - 100%</span> - Dark green</li>
//                             </ul>
//                         </CardContent>
//                     </Card>
//                </FormControl>
